...
Route::get('/register', 'AppController@index')->name('App_Register');;



Route::get('/{any?}', 'AppController@index')->where('any', '.*$'); //middleware('auth')-> ^(?!api\/)[\/\w\.\,-]*
// Route::middleware('auth:sanctum')->get('/{any?}/{anya?}', 'AppController@index'); //middleware('auth')->
// Route::middleware('auth:sanctum')->get('/{any?}/{anya?}/{anyb?}', 'AppController@index'); //middleware('auth')->
