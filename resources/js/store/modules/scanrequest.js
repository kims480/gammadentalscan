...
export const mutations = {
    ...
    SET_Teeth: (state, teeth) => {
        ...
        localStorage.setItem(
            "currentTeeth",
            JSON.stringify(state.threeDImaging)
        );
    },
    ...
    SET_RequiredPhoto: (state, teeth) => {
        ...
        localStorage.setItem(
            "RequiredPhoto",
            JSON.stringify(state.RequiredPhoto)
        );
    },
    ...
    SET_ThreeDPrinting: (state, teeth) => {
        ...
        localStorage.setItem(
            "ThreeDPrinting",
            JSON.stringify(state.ThreeDPrinting)
        );
    },
...
export const actions = {
    ...
    loadRequest({ state }) {
        state.purposes =
            ...
            Object.assign(state.purposes, getDefaultState().purposes);
        state.otherPurpose =
            JSON.parse(localStorage.getItem("otherPurpose")) ??
            Object.assign(state.otherPurpose, getDefaultState().otherPurpose);
        state.threeDImaging =
            JSON.parse(localStorage.getItem("currentTeeth")) ??
            Object.assign(state.threeDImaging, getDefaultState().threeDImaging);
        state.TwoDImaging =
            JSON.parse(localStorage.getItem("TwoDImaging")) ??
            Object.assign(state.TwoDImaging, getDefaultState().TwoDImaging);
        state.RequiredPhoto =
            JSON.parse(localStorage.getItem("RequiredPhoto")) ??
            Object.assign(state.RequiredPhoto, getDefaultState().RequiredPhoto);
        state.ThreeDPrinting =
            JSON.parse(localStorage.getItem("ThreeDPrinting")) ??
            Object.assign(
                state.ThreeDPrinting,
                getDefaultState().ThreeDPrinting
            );
        state.Photography =
            JSON.parse(localStorage.getItem("Photography")) ??
            Object.assign(state.Photography, getDefaultState().Photography);
        state.doctor =
            JSON.parse(localStorage.getItem("doctor")) ??
            Object.assign(state.doctor, getDefaultState().doctor);
        state.patient =
            JSON.parse(localStorage.getItem("patient")) ??
            Object.assign(state.patient, getDefaultState().patient);
    },
    initRequest({ state }) {
        localStorage.removeItem("currentPurposes");
