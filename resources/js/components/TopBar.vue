<template>
    <div class="main-header" :is="getThemeMode.layout">
        <div class="logo">
                    ...
                    <div class="row m-0">
                        <div class="col-md-4 p-4 text-left bg-img">
                            ...
                            <p>
                                ...
                                adipisicing elit. Asperiores natus laboriosam
                                fugit, consequatur.
                            </p>
                            <p class=" mb-30">
                                Lorem ipsum dolor sit amet consectetur,
                                adipisicing elit. Exercitationem odio amet eos
                                dolore suscipit placeat.
                            </p>
                            <button
                                class="btn btn-lg btn-rounded btn-outline-warning"
                            >
                                Learn More
                            </button>
                        </div>
        ...
        <div class="header-part-right">
            ...
            <div class="dropdown">
                ...
                >
                    <template slot="button-content">
                        <img
                            src="@/../sass/assets/images/faces/1.jpg"
                            id="userDropdown"
                            alt
                            data-toggle="dropdown"
                            aria-haspopup="true"
