    ...
    <div class="container p-0">
        ...
        <div class="col-md-5 col-xl-4">
            ...
            <div class="card">
                ...
                <div class="list-group list-group-flush" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#emailnotif" role="tab">
                      Email notifications
                    </a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#webnotif" role="tab">
                      Web notifications
                    </a>

                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#delAccount" role="tab">
                      Delete account
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-7 col-xl-8">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="emailnotif" role="tabpanel">
                    <p>emailnotif</p>
                </div>
                <div class="tab-pane fade show active" id="webnotif" role="tabpanel">
                    <p>webnotif</p>
                </div>
                <div class="tab-pane fade show active" id="delAccount" role="tabpanel">
                    <p>Delete Account</p>
                </div>
            </div>
        </div>
