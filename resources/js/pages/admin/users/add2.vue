    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        >
          ...
          <div class="row">
            <div
              class="input-group col-md-6 col-sm-12 mb-3 py-0"
              :class="{ 'form-group--error': $v.myForm.name.$error }"
            >
              ...
              <input
                ...
                :class="{
                  'is-invalid': $v.myForm.name.$error,
                  'is-valid': !$v.myForm.name.$invalid,
                }"
                v-model.trim="$v.myForm.name.$model"
                @input="setName($event.target.value)"
              />

              <div v-if="!$v.myForm.name.$invalid" class="valid-feedback">
                Looks good!
              </div>

              <div class="invalid-feedback">
                <span v-if="!$v.myForm.name.required">Name is required</span>
                <span v-if="!$v.myForm.name.minLength"
                  >Name must be more than
                  {{ $v.myForm.name.$params.minLength.min }} letters</span
                >
                <span v-if="!$v.myForm.name.maxLength"
                  >Name must be less than
                  {{ $v.myForm.name.$params.maxLength.max }} letters</span
                >
              </div>
            ...
            >
              <input
                ...
                :class="{
                  'is-invalid': $v.myForm.email.$error,
              ...
              <div v-if="!$v.myForm.email.$invalid" class="valid-feedback">
                Looks good!
              </div>
              ...
              <div class="invalid-feedback">
                ...
                >
                <span v-if="!$v.myForm.email.isUnique"
                  >this email already exist</span
                >
              </div>
            ...
            <div
              class="input-group col-md-6 col-sm-12 mb-3 py-0"
              :class="{ 'form-group--error': $v.myForm.password.$error }"
            >
              <input
                class="form-control"
                :type="textpassword"
                :class="{
                  'is-invalid': $v.myForm.password.$error,
                  'is-valid': !$v.myForm.password.$invalid,
                }"
              ...
              <div v-if="!$v.myForm.password.$invalid" class="valid-feedback">
                Looks good!
              </div>

              <div class="invalid-feedback">
                <span v-if="!$v.myForm.password.required"
                  >password is required</span
                >
                <span v-if="!$v.myForm.password.minLength"
                  >password must be more than
                  {{ $v.myForm.password.$params.minLength.min }} letters</span
                >
                <span v-if="!$v.myForm.password.maxLength"
                  >password must be less than
                  {{ $v.myForm.password.$params.maxLength.max }} letters</span
                >
              </div>
              <!-- <div class="invalid-valid-feedback"> Please choose a username.</div> -->
              <!-- <div class="invalid-invalid-feedback"> Please choose a username.</div> -->
            ...
            <div
              class="input-group col-md-6 col-sm-12 mb-3 py-0"
              :class="{
                'form-group--error': $v.myForm.confirm_password.$error,
              }"
            >
              <input
                class="form-control"
                ...
                :class="{
                  'is-invalid': $v.myForm.confirm_password.$error,
                  'is-valid': !$v.myForm.confirm_password.$invalid,
                }"
                v-model.trim="$v.myForm.confirm_password.$model"
                @input="setconfirm_password($event.target.value)"
              ...
              <div class="input-group-append">
                <span class="input-group-text" id="basic-addon2"
                  ><i
                    class="fa"
                    :class="{
                      'fa-eye': !toggleConfirmPassword,
                      'fa-eye-slash': toggleConfirmPassword,
                    }"
              ...
              <div
                v-if="!$v.myForm.confirm_password.$invalid"
              ...
              <div class="invalid-feedback">
                <span v-if="!$v.myForm.confirm_password.required"
                  >Password Confirmation is required</span
                >
                <span v-if="!$v.myForm.confirm_password.sameAsPassword"
                  >Password Confirmation must be Same as Password</span
                >
              </div>
              <!-- <div class="invalid-valid-feedback"> Please choose a username.</div> -->
              <!-- <div class="invalid-invalid-feedback"> Please choose a username.</div> -->
            ...
            <div
              class="input-group col-md-6 col-sm-12 mb-3 py-0"
              :class="{
                'form-group--error': $v.myForm.phone.$error,
                'form-group--loading': $v.myForm.phone.$pending,
              }"
            >
              <div class="input-group-prepend">
              ...
              <input
                ...
                type="text"
                :class="{
                  'is-invalid': $v.myForm.phone.$error,
                  'is-valid': !$v.myForm.phone.$invalid,
                }"
              ...
              />
              <div v-if="!$v.myForm.phone.$invalid" class="valid-feedback">
                Looks good!
              </div>

              <div class="invalid-feedback">
                <span v-if="!$v.myForm.phone.required">phone is required</span>
                <span v-if="!$v.myForm.phone.minLength"
                  >phone must be more than
                  {{ $v.myForm.phone.$params.minLength.min }} letters</span
                >
                <span v-if="!$v.myForm.phone.maxLength"
                  >phone must be less than
                  {{ $v.myForm.phone.$params.maxLength.max }} letters</span
                >
              </div>
            </div>
            <div
            ...
            >
              ...
              <input
                ...
                aria-label="Whatsapp"
              />
              <div v-if="!$v.myForm.whatsapp.$invalid" class="valid-feedback">
                Looks good!
              </div>

              <div class="invalid-feedback">
                <span v-if="!$v.myForm.whatsapp.required"
            ...
            <div class="input-group col-md-6 col-sm-12 mb-3 py-0">
            ...
            <div class="input-group col-md-6 col-sm-12 mb-3 py-0">
              <label class="switch pr-5 switch-success mr-3"
                ><span
                  ...
                  title=""
                  data-html="true"
                  data-original-title="If <i style='color:red;font-weigh:bold'>De-Activated!</i> user will be holded and not able to handel any process"
                  >Active</span
                >
                <input
                  type="checkbox"
          ...
          <button
            ...
            @click="id ? updateUser() : submit()"
          >
            {{ $route.params.id ? "Update User" : "Add User" }}
          </button>
          <!-- type="submit" -->
...
export default {
  ...
  methods: {
    ...
    updateUser() {
      ...
      this.$store
        .dispatch("users/userUpdate", formData)
        .then((res) => {
          console.log(res);
          this.submitStatus = "OK";
