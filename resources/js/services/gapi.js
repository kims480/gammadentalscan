            ...
            if (e["::"] && b.length) {
                ...
                for (var f = null; (f = b.shift()); ) {
                    ...
                    var k = (a.length && a[a.length - 1]) || null,
                        w = k;
                    (k && k.hint == l) || ((w = { hint: l, b: [] }), a.push(w));
                    w.b.push(f);
                }
                var y = a.length;
                if (1 < y) {
...
gapi.load("", {
    ...
    _c: {
        jsl: {
            ...
            h:
                "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.X8eNpfbhSO4.O/am\u003dwQE/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCMR_96uYzPfkrcqh5Ji4P5RQoxTGg/m\u003d__features__",
